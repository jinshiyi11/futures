...
//	 * 置顶评论列表
//	 */
//	private ArrayList<Comment> mTopCommentList=new ArrayList<Comment>();
//	/**
//	 * 是否已获取置顶评论
//	 */
//	private boolean mGotTopComments;
...
//
//		mInsuranceId = getIntent().getStringExtra(Constants.EXTRA_INSURANCE_ID);
//
...
//
//		mEtComment.setOnKeyPreImeListener(new OnKeyPreImeListener() {
//
//			@Override
...
//			if(isPullDown){
//				int index=0;
//            	if(mTopCommentList!=null && mCommentList.size()>mTopCommentList.size())
//            		index=mTopCommentList.size();
//
//				timeStamp=mCommentList.get(index).getCommentTime();
//			}else{
//				timeStamp=mCommentList.get(mCommentList.size()-1).getCommentTime();
//			}
//		}else{
...
//		//获取置顶评论
//		if(!mGotTopComments){
//			GetTopCommentListTask request=new GetTopCommentListTask(mContext, mInsuranceId, new Listener<ArrayList<Comment>>() {
//
//				@Override
...
//						return;
//
//					mGotTopComments=true;
//					mTopCommentList=response;
//					mCommentList.addAll(0, response);
...
//		}
//
//		GetCommentListTask request = new GetCommentListTask(mContext,mInsuranceId,timeStamp,PAGE_COUNT,after, new Listener<ArrayList<Comment>>() {
//
//					@Override
...
//			intent.putExtra(Constants.EXTRA_INSURANCE_ID, mInsuranceId);
...
//		showProgressDialog();
//
//		String originalCommentId=null;
//		if(mSelectedComment!=null)
//			originalCommentId= String.valueOf(mSelectedComment.getCommentId());
//
//		SubmitCommentTask request = new SubmitCommentTask(mContext,mInsuranceId,originalCommentId,
