...
class IcsLinearLayout extends LinearLayout {
    ...
    public IcsLinearLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IcsLinearLayout);
        mDivider=a.getDrawable(R.styleable.IcsLinearLayout_divider);
        mDividerPadding=(int) a.getDimension(R.styleable.IcsLinearLayout_dividerPadding, 0);
        mShowDividers=a.getInt(R.styleable.IcsLinearLayout_xshowDividers, 0);
        a.recycle();
	}
